...
import { Button, useToast, ButtonGroup, Center, Box, Heading, Container } from '@chakra-ui/react'
...
setBtnStatus( (prev)=>({...initialState, [btn] : !prev.btn})  )
...
<Box  h='100px'>
  <Center m={10} height='0' p='4' color='white' axis='both' >
  <Heading id="heading"
...
<Button isDisabled={totalSeconds}  colorScheme={"messenger"} onClick={startTimer} rightIcon={<TimeIcon/ >} >Start </Button>
</Container>
    </>
  )
}
